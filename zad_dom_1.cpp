...
double liczba = a*100; //przesuwamy liczbę o precyzję np: 0,123123 = 12,3123

        int b = (int)liczba; //robimy z tego int 12,3123 = 12

        liczba =(double)b/100; //przesuwamy do precyzji 12 = 0,12

        return liczba; //zwracamy liczbę z precyzjš 2
}
...
cout<<"Najmniejsza liczba naturalna C dla ktorej można umiescic prostokat 100 x 26,\n wewnatrz pola ograniczonego wykresem funkcji to: "<<C<<endl;
